  ...
  return (
    <footer className="relative border-t border-[rgba(79,142,247,0.1)] pt-20 pb-10 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10 relative z-10">
          ...
          <div className="md:col-span-2 flex flex-col gap-5">
            ...
            <div className="flex items-center gap-3 mt-2">
              {[
                ...
                {
                  label: "YouTube",
                  path: "M22.54 6.42a2.78 2.78 0 00-1.95-1.96C18.88 4 12 4 12 4s-6.88 0-8.59.46a2.78 2.78 0 00-1.95 1.96A29 29 0 001 12a29 29 0 00.46 5.58A2.78 2.78 0 003.41 19.6C5.12 20 12 20 12 20s6.88 0 8.59-.46a2.78 2.78 0 001.95-1.95A29 29 0 0023 12a29 29 0 00-.46-5.58z M10 15l5-3-5-3v6z",
                },
              ].map((social) => (
                <a
                  key={social.label}
        ...
        {/* Newsletter Row */}
        <div className="glass-card p-8 flex flex-col sm:flex-row items-center gap-6 mb-16"
        ...
        >
          ...
          <div className="flex gap-3 w-full sm:w-auto">
            ...
            <button
              ...
              className="btn-primary text-white text-sm font-semibold px-6 py-3 rounded-xl whitespace-nowrap"
            >
              Subscribe
            </button>
          </div>
